...
const FacultyApproval = () => {
    // Access shared state from the FacultyLayout
    ...
    useEffect(() => {
        // Fetch pending achievements based on the selected class
        ...
        return () => unsubscribe();
    }, [selectedClass]); // Re-run query when the selected class changes
